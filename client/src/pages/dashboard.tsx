  ...
  const statsData = [
    {
      ...
      value: statsLoading ? "..." : formatCurrency((stats as any)?.dailyRevenue || 0),
      icon: DollarSign,
      color: "text-green-600",
    },
    {
      title: "Serviços Hoje",
      value: statsLoading ? "..." : (stats as any)?.dailyServices || 0,
      icon: Wrench,
      color: "text-blue-600",
    },
    {
      title: "Agendamentos",
      value: statsLoading ? "..." : (stats as any)?.appointments || 0,
      icon: Calendar,
      color: "text-amber-600",
    },
    {
      title: "Clientes Ativos",
      value: statsLoading ? "..." : (stats as any)?.activeCustomers || 0,
      icon: Users,
