...
import { Camera, Upload, CheckCircle, XCircle, Loader2, Copy, ArrowLeft } from "lucide-react";
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                <h4 className="font-medium mb-2">1. Capture a imagem</h4>
                <p className="text-gray-600 dark:text-gray-400">
                  Use a câmera do dispositivo ou faça upload de uma foto da placa
                </p>
              </div>
              <div>
                <h4 className="font-medium mb-2">2. Processe a imagem</h4>
                <p className="text-gray-600 dark:text-gray-400">
                  Clique em "Processar Imagem" para extrair automaticamente a placa
                </p>
              </div>
              <div>
